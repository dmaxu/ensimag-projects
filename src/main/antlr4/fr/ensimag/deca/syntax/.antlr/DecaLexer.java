// Generated from /home/midoui/ensimag/GL/gl47/src/main/antlr4/fr/ensimag/deca/syntax/DecaLexer.g4 by ANTLR 4.13.1
...
public class DecaLexer extends AbstractDecaLexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"PROTECTED", "RETURN", "THIS", "TRUE", "WHILE", "LETTER", "DIGIT", "STRING_CAR", 
			"ESCAPE_SEQ", "EOL", "POSITIVE_DIGIT", "NUM", "SIGN", "EXP", "DEC", "FLOATDEC", 
			"DIGITHEX", "NUMHEX", "FLOATHEX", "IDENT", "STRING", "MULTI_LINE_STRING", 
			"INT", "FLOAT", "AND", "CBRACE", "CBRACKET", "COMMA", "CPARENT", "DOT", 
			"EQUALS", "EQEQ", "EXCLAM", "GEQ", "GT", "LEQ", "LT", "MINUS", "NEQ", 
			"OBRACE", "OBRACKET", "OPARENT", "OR", "PERCENT", "PLUS", "SEMI", "SLASH", 
			"TIMES", "SINGLE_LINE_COMMENT", "MULTI_LINE_COMMENT", "WS", "FILENAME", 
			"INCLUDE"
		};
	}
