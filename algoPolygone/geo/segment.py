...
class Segment:
    ...
    def is_vertical(self):
        ...
        """
        return self.endpoints[0].c[0] == self.endpoints[1].coordinates[0]
    ...
    def intersects(self, other_segment):
        A, B = self.endpoints
        C, D = other_segment.endpoints

        def ccw(A, B, C):
            return (C.coordinates[1] - A.coordinates[1]) * (B.coordinates[0] - A.coordinates[0]) > \
