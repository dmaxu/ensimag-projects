...
class Quadrant:
    ...
    def is_inside(self, other):
        """
        Check if this quadrant is inside the other quadrant.
        """
        return all(self.min_coordinates[i] >= other.min_coordinates[i] and
                   self.max_coordinates[i] <= other.max_coordinates[i]
