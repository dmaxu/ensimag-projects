...
public abstract class AbstractDeclClass extends Tree {
    ...
    public abstract void genClassTable(DecacCompiler compiler, LabelOperand objectEquals) ;
    public abstract void codegenClass(DecacCompiler compiler) throws CLIException;
