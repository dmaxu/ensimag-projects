...
public class Greater extends AbstractOpIneq {
    ...
    protected void codeGenCond(boolean cond, Label label, DecacCompiler compiler) throws CLIException {
        LOG.debug("codeGenCond Greater: start");

        // le register ou l'opérand à droite        
        GPRegister regRight;
        DVal adresse;
        ...
        LOG.debug("codeGenCond Greater: end");
...
//        compiler.addInstruction(new SGT(compiler.getMemoryManager().getRegister(compiler)));
//
//    }
}
