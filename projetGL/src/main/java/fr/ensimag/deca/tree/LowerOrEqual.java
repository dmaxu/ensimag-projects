...
public class LowerOrEqual extends AbstractOpIneq {
    ...
    protected void codeGenCond(boolean cond, Label label, DecacCompiler compiler) throws CLIException {
        LOG.debug("codeGenCond LowerOrEqual: start");
        GPRegister regRight;
        DVal adresse;
        ...
        LOG.debug("codeGenCond LowerOrEqual: end");
...
//        compiler.addInstruction(new SLE(compiler.getMemoryManager().getRegister(compiler)));
//
//    }
